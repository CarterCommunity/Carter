namespace CarterNativeSample.Features.FunctionalProgramming
{
    using System;
    using CarterNativeSample.Features.FunctionalProgramming.CreateDirector;
    using CarterNativeSample.Features.FunctionalProgramming.DeleteDirector;
    using CarterNativeSample.Features.FunctionalProgramming.GetDirectorById;
    using CarterNativeSample.Features.FunctionalProgramming.ListDirectors;
    using CarterNativeSample.Features.FunctionalProgramming.UpdateDirector;
        ...
        public static ListDirectorsRoute.ListDirectorsHandler ListDirectorsHandler
        {
            get
            {
                return listDirectors ?? (() => ListDirectorsRoute.Handle(listDirectors: () =>
                {
                    ...
                    return new[] { new Director{Name = "Steven Spielberg"} };
